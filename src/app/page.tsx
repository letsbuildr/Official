    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-12">
      ...
      <div className="flex flex-col items-center text-center">
        <Image
          ...
          className="mb-4 mx-auto"
        />
        <h3 className="text-lg font-semibold mb-3 text-[#0B1E36]">Plan</h3>
      ...
      <div className="flex flex-col items-center text-center">
        <Image
          ...
          className="mb-4 mx-auto"
        />
        <h3 className="text-lg font-semibold mb-3 text-[#0B1E36]">Design</h3>
        <p className="text-[#FFFFFF] text-sm max-w-xs">
      ...
      <div className="flex flex-col items-center text-center">
        <Image
          ...
          className="mb-4 mx-auto"
        />
        <h3 className="text-lg font-semibold mb-3 text-[#0B1E36]">Develop</h3>
        <p className="text-[#FFFFFF] text-sm max-w-xs">
      ...
      <div className="flex flex-col items-center text-center">
        <Image
          ...
          className="mb-4 mx-auto"
        />
        <h3 className="text-lg font-semibold mb-3 text-[#0B1E36]">Launch</h3>
        <p className="text-[#FFFFFF] text-sm max-w-xs">
      ...
      <div className="flex flex-col items-center text-center">
        <Image
          ...
          className="mb-4 mx-auto"
        />
        <h3 className="text-lg font-semibold mb-3 text-[#0B1E36]">Support</h3>
        <p className="text-[#FFFFFF] text-sm max-w-xs">
        ...
        <ul className="text-gray-600 text-sm space-y-3 text-left pl-4">
          {plan.benefits.map((benefit, i) => (
            <li key={i} className="flex items-center gap-2">
              <Image src="/Margin.png" alt="check" width={18} height={18} />
              <span>{benefit}</span>
            </li>
          ))}
        </ul>
